...
const url = "https://cosmin-afta-haskell.herokuapp.com/"
require("dotenv").config()
const JWT = process.env.JWT || require("./secret.js").JWT

describe.skip("haskell microservice tests", () => {
  it("haskell hello world program should return accordingly", async () => {
